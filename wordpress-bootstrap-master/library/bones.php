...
function bones_theme_support() {
	...
	set_post_thumbnail_size(125, 125, true);   // default thumb size
        ...
        $args = array(
            'default-color' =>  '#ebe8e9'
        );
        
	add_theme_support( 'custom-background', $args);  // wp custom background
...
/**
 * Adding pull-right to the nav bar. This will be removed if parent theme is updated.
 */
...
// Removed as we want the images to be padded. If removing possible add in a class to the images so that we can control them?
